...
class EncuestaRespuestaScreen extends StatefulWidget {
  static String id = "encuesta_respuesta_page";

  const EncuestaRespuestaScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<EncuestaRespuestaScreen> createState() => _EncuestaRespuestaState();
}

class _EncuestaRespuestaState extends State<EncuestaRespuestaScreen> {
